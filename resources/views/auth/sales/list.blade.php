...
<div class="w-[95%] m-10 bg-neutral-100 border border-neutral-200 p-8 rounded-lg shadow">
    <div class="flex mb-8">
        <form method="get" class="flex gap-4 w-full">
            ...
            <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-blue-600 hover:text-neutral-100 cursor-pointer transition-all">Search customer</button>
            <a href="/sales/customers" class="flex items-center bg-blue-500 text-white text-sm py-1 px-2 rounded-full hover:bg-blue-600 hover:text-neutral-100 cursor-pointer transition-all">All sales</a>
        </form>
    </div>
    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="rounded-lg">
            <tr class="text-neutral-900">
                ...
                <th class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">Start a new sale</th>
            </tr>
        </thead>
