...
<div class="w-[95%] m-10 bg-neutral-100 border border-neutral-200 p-8 rounded-lg shadow">
    <div class="flex mb-8">
        <form method="get" class="flex gap-4 w-full">
            ...
            <a href="/sales/customers" class="flex items-center bg-blue-500 text-white text-sm py-1 px-2 rounded-full hover:bg-blue-600 hover:text-neutral-100 cursor-pointer transition-all">All customers</a>
        </form>
    </div>
            ...
            @foreach ($sales as $sale)
                <tr class="text-neutral-900 border-b-neutral-300 hover:bg-neutral-200 transition-all">
                    ...
                    <td class="flex items-center gap-2 p-2 whitespace-nowrap">
                        <a href="/receipts?filter={{ $sale->cpf_cnpj }}" class="bg-emerald-500 py-1 px-2 rounded hover:bg-emerald-600 hover:text-neutral-100 transition-all">
